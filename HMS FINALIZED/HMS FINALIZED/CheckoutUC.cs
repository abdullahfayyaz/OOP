...
namespace HMS_FINALIZED
{
    public partial class CheckoutUC : UserControl
    {
        ...
        private void CheckoutGradientButton_Click(object sender, EventArgs e)
        {
                ...
                else
                {
                    ...
                    foreach (Person p in PersonDL.PersonList)
                    {
                        if (info.Name == p.Name && info.Id == p.Id)
                        {
                            ...
                            labelBill.Text = Convert.ToString(p.Bill);
                            break;
                        }
                    }
                    Panel_Checkout.Visible = true;
