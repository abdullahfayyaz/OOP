...
namespace HMS_V2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string usersPath = "C:\\Users\\HP\\Documents\\STUDY\\2nd Semester\\OOP TASK\\HMS V2\\Users.txt";
            string customersPath = "C:\\Users\\HP\\Documents\\STUDY\\2nd Semester\\OOP TASK\\HMS V2\\Customers.txt";
            ...
            do
            {
                ...
                here:
                    ...
                    if (valid_name == true)
                    {
                        ...
                        if (valid == true)
                        {
                            role = login(userData, name, password);
                            if (role == "manager")
                            {
        ...
        static bool isValidUsername(List<user> userData, user u)
        {
            bool isNew = true;
        ...
        here:
            ...
            if (valid_name == true)
            {
                ...
                if (valid == true)
                {
                    bool signUpCheck = isValidUsername(userData, u);
                    if (signUpCheck == true)
                    {
                        userData.Add(u);
        ...
        static string login(List<user> userData, string name, string password)
        {
            ...
            while (true)
            {
                ...
                there:
                    ...
                    if (valid == true)
                    {
                        ...
                        if (valid_id == true)
                        {
                            bool isCheck = checkCustomer(customerData, c);
                            if (isCheck == true)
                            {
                    ...
                    if (valid == true)
                    {
                        ...
                        if (id_valid == true)
                        {
                            ...
                            else
                            {
                                printHeader();
                                subMenu("Checkout");
                                int bill = checkoutBill(customerData, isFound);
        ...
        // Add Customer
        static bool checkCustomer(List<customer> customerData, customer c)
        {
            bool isNew = true;
            for (int i = 0; i < customerData.Count(); i++)
            {
                    ...
                    else
                    {
                        while (true)
                        {
                            ...
                            if (option_update == "1")
                            {
                                ...
                                if (valid_name == true)
                                {
                                    updateName(customerData, c, isFound);
                                }
                                else if (valid_name == false)
                                {
                                    Console.WriteLine("Enter a Valid Name");
                            ...
                            else if (option_update == "2")
                            {
                                ...
                                if (valid_totalPerson == true)
                                {
                                    updateTotalPerson(customerData, c, isFound);
                                }
                                else if (valid_totalPerson == false)
                                {
                                    Console.WriteLine("Wrong Input\nTry Again");
                            ...
                            else if (option_update == "3")
                            {
                                ...
                                if (valid_roomType == true)
                                {
                                    updateRoomType(customerData, c, isFound);
                                }
                                else if (valid_roomType == false)
                                {
                                    Console.WriteLine("Wrong Input\nTry Again");
                            ...
                            else if (option_update == "4")
                            {
                                ...
                                if (valid_stay == true)
                                {
                                    updateStayDay(customerData, c, isFound);
                                }
                                else if (valid_stay == false)
                                {
                                    Console.WriteLine("Wrong Input\nTry Again");
        ...
        static void updateName(List<customer> customerData, customer c, int index)
        {
            customer change = new customer();
            change = customerData[index];
            change.name = c.name;
        }
        static void updateTotalPerson(List<customer> customerData, customer c, int index)
        {
            customer change = new customer();
            change = customerData[index];
            change.totalPerson = c.totalPerson;
        }
        static void updateRoomType(List<customer> customerData, customer c, int index)
        {
            customer change = new customer();
            change = customerData[index];
            change.roomType = c.roomType;
        }
        static void updateStayDay(List<customer> customerData, customer c, int index)
        {
            customer change = new customer();
            change = customerData[index];
            change.no_of_stay = c.no_of_stay;
        }
        ...
        static void roomSuggestion(customer c)
        {
            if (c.totalPerson == "1")
            {
                Console.WriteLine("---------------------");
            ...
            else if (c.totalPerson == "4" || c.totalPerson == "5")
            {
                Console.WriteLine("---------------------");
                Console.WriteLine("Recommended Room Type");
                Console.WriteLine("> King");
        ...
        static int checkoutBill(List<customer> customerData, int index)
        {
            int bill = 0;
            roomCategories r = new roomCategories();
            customer c = new customer();
